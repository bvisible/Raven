...
export default function useFileUpload(channelID: string) {
  ...
  const uploadFiles = async (selectedMessage?: Message | null, threadMessageId?: string | null): Promise<RavenMessage[]> => {
        ...
        return file.uploadFile(f,
          {
            ...
            otherData: {
              ...
              thread_message_id: threadMessageId || ""  // Pass the message ID to attach file to
            },
            fieldname: 'file',
          },
