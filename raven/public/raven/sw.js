 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn="FirebaseError";class N extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=Sn,Object.setPrototypeOf(this,N.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,W.prototype.create)}}class W{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?Tn(i,r):"Error",o=`${this.serviceName}: ${a} (${s}).`;return new N(s,o,r)}}function Tn(t,e){return t.replace(Rn,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Rn=/\{\$([^}]+)}/g;function oe(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],a=e[s];if(Le(i)&&Le(a)){if(!oe(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function Le(t){return t!==null&&typeof t=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zn{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Gn(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function Gn(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ue="@firebase/app",Ue="0.9.29";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nr(t){O(new S("platform-logger",e=>new zn(e),"PRIVATE")),O(new S("heartbeat",e=>new kr(e),"PRIVATE")),D(ue,Ue,t),D(ue,Ue,"esm2017"),D("fire-js","")}Nr("");var Mr="firebase",Lr="10.9.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ot=1e4,ct=`w:${be}`,lt="FIS_v2",Pr="https://firebaseinstallations.googleapis.com/v1",Br=3600*1e3,$r="installations",Ur="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bt=new Map;function wt(t,e){const n=z(t);yt(n,e),Gr(n,e)}function yt(t,e){const n=bt.get(t);if(n)for(const r of n)r(e)}function Gr(t,e){const n=Jr();n&&n.postMessage({key:t,fid:e}),Yr()}let C=null;function Jr(){return!C&&"BroadcastChannel"in self&&(C=new BroadcastChannel("[Firebase] FID Change"),C.onmessage=t=>{yt(t.data.key,t.data.fid)}),C}function Yr(){bt.size===0&&C&&(C.close(),C=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vt="installations",ms="installations-internal",bs=t=>{const e=t.getProvider("app").getImmediate(),n=gs(e),r=me(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},ws=t=>{const e=t.getProvider("app").getImmediate(),n=me(e,vt).getImmediate();return{getId:()=>fs(n),getToken:s=>ds(n,s)}};function ys(){O(new S(vt,bs,"PUBLIC")),O(new S(ms,ws,"PRIVATE"))}ys();D(at,be);D(at,be,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ct="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",_s="https://fcmregistrations.googleapis.com/v1",St="FCM_MSG",Is="google.c.a.c_id",Es=3,vs=1;var H;(function(t){t[t.DATA_MESSAGE=1]="DATA_MESSAGE",t[t.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(H||(H={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const As="firebase-messaging-database",ks=1,k="firebase-messaging-store";let ie=null;function Ie(){return ie||(ie=q(As,ks,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(k)}}})),ie}function Ee(t){return c(this,null,function*(){const e=Ce(t),r=yield(yield Ie()).transaction(k).objectStore(k).get(e);if(r)return r;{const s=yield Ts(t.appConfig.senderId);if(s)return yield ve(t,s),s}})}function ve(t,e){return c(this,null,function*(){const n=Ce(t),s=(yield Ie()).transaction(k,"readwrite");return yield s.objectStore(k).put(e,n),yield s.done,e})}function Ds(t){return c(this,null,function*(){const e=Ce(t),r=(yield Ie()).transaction(k,"readwrite");yield r.objectStore(k).delete(e),yield r.done})}function Ce({appConfig:t}){return t.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hi(t=vr()){return li().then(e=>{if(!e)throw g.create("unsupported-browser")},e=>{throw g.create("indexed-db-unsupported")}),me(et(t),"messaging-sw").getImmediate()}function fi(t,e){return t=et(t),ui(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */
"url":"assets/DocumentNotificationList-CMH-Snbp.js"},{"revision":null,"url":"assets/DocumentNotificationForm-BPH5Z_x8.js"},{"revision":null,"url":"assets/DoctypeVariableDialogForm-DDTT8jVN.js"},{"revision":null,"url":"assets/DoctypeLinkRenderer-DvN-0xQi.js"},{"revision":null,"url":"assets/DeleteAlert-DA9yf6OX.js"},{"revision":null,"url":"assets/DateSeparator-ChfFJrfr.js"},{"revision":null,"url":"assets/CustomEmojiList-B-PLT4nq.js"},{"revision":null,"url":"assets/CreateWebhook-BlyfMHqy.js"},{"revision":null,"url":"assets/CreateSchedulerEvent-BSbxBDn0.js"},{"revision":null,"url":"assets/CreateSavedPrompt-BhZfnydL.js"},{"revision":null,"url":"assets/CreatePoll-CE21K4bl.css"},{"revision":null,"url":"assets/CreatePoll--B35SSyS.js"},{"revision":null,"url":"assets/CreateMessageAction-mDjx43C7.js"},{"revision":null,"url":"assets/CreateInstructionTemplate-DgQ9vsbh.js"},{"revision":null,"url":"assets/CreateFunction-BtV3iKUx.js"},{"revision":null,"url":"assets/CreateDocumentNotification-Dk6oBUez.js"},{"revision":null,"url":"assets/CreateBot-B_tEnNld.js"},{"revision":null,"url":"assets/CommonSettingsMenu-Bfm9ZP9i.js"},{"revision":null,"url":"assets/CodeBlock-BOsMUnOw.js"},{"revision":null,"url":"assets/ChatSpace-DmyjFcXN.js"},{"revision":null,"url":"assets/BotList-De3ncvsZ.js"},{"revision":null,"url":"assets/BotForm-yaJG3NRj.js"},{"revision":null,"url":"assets/AuthContainer-BRZFRZ03.js"},{"revision":null,"url":"assets/Appearance-Bw32D6hr.js"},{"revision":null,"url":"assets/AddWorkspaceMemberModalContent-C-HRik9Q.js"},{"revision":null,"url":"assets/AddRavenUsersPage-D0yajuuW.js"},{"revision":null,"url":"assets/AddMembersDropdown-BkUiR77h.js"},{"revision":null,"url":"assets/AddCustomEmojiDialog-CwTe9g0g.js"},{"revision":null,"url":"assets/AISettings-3nIkGgA7.js"},{"revision":null,"url":"assets/AINotEnabledCallout-CcEEEBR_.js"},{"revision":"3e7262ed7935e7c8062e6817e9c1c7eb","url":"manifest.webmanifest"}]);hn();const di=new URL(location).searchParams.get("config");try{let n=function(){return navigator.userAgent.toLowerCase().includes("chrome")};const t=rt(JSON.parse(di)),e=hi(t);fi(e,r=>{const s=r.notification.title;let i={body:r.notification.body||""};r.data.image&&(i.icon=r.data.image),r.data.creation&&(i.timestamp=r.data.creation);let a=`${r.data.base_url}/raven/channel/${r.data.channel_id}`;r.data.message_url&&(a=r.data.message_url),n()?i.data={url:a}:i.actions=[{action:a,title:"View"}],self.registration.showNotification(s,i)}),n()&&self.addEventListener("notificationclick",r=>{r.stopImmediatePropagation(),r.notification.close(),r.notification.data&&r.notification.data.url&&clients.openWindow(r.notification.data.url)})}catch(t){console.log("Failed to initialize Firebase",t)}self.skipWaiting();pn();console.log("Service Worker Initialized");
