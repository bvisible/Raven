...
| `raven/public/raven/safari-pinned-tab.svg` | Verbatim copy of `frontend/public/safari-pinned-tab.svg`, which is **unchanged from upstream**. It only appears in the diff because the build output is committed. |
