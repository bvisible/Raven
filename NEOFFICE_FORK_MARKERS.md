...
| `raven/raven/onboarding_step/introduction_to_raven/introduction_to_raven.json` | Rebranded to Synk (`1d6dea095`, `49ee6e172`, `93a79031c`). ⚠️ **Damaged** — see "Known defects" 2 and 3. |
| `raven/raven/onboarding_step/access_the_web_app/access_the_web_app.json` | Rebranded to Synk (`49ee6e172`, `93a79031c`). ⚠️ **Damaged** — see "Known defects" 3 and 4. |
